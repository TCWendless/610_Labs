...
axes[1].set_title("Noisy sampled signal", fontweight="bold", loc="center")
...
axes[2].set_title("PSD of Noisy Signal", fontweight="bold", loc="center")
