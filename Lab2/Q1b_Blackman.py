...
window = np.blackman(sample_points)
...
axes[1].set_title("Noisy sampled signal with Blackman window", fontweight="bold", loc="center")
...
axes[2].set_title("PSD of Noisy Signal with Blackman window", fontweight="bold", loc="center")
