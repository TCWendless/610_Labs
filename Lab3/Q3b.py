...
h_out = h_FIR * 1/(1 - a1 * z**(-1) - a2 * z**(-2) - a2 * z**(-3) - a2 * z**(-4))       # transfer function for IIR generateing by CR
...
axes.plot(w/1e6, 20 * np.log10(abs(h_out)), 'blue', label = 'Case b (never discharged)')
